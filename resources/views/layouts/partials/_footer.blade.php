<!-- #Footer# -->
	<div class="section bg-light mt-4" id="footer">
		<div class="container">
			<div class="row">
				<div class="col-sm-4"> <img src="{{ asset('images/logo/Gatewize Logo.png') }}" class="img-fluid" alt="Gatewize Logo" width="50%"/>
					<p class="mt-3 ml-1 text-muted">Gatewize is a SASS software landing page template. </p>
