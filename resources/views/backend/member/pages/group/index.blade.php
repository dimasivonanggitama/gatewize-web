                        ...
                        <table id="group-table" class="table dataTable no-footer" role="grid" aria-describedby="order-listing_info">
                            ...
                            <tbody>     
                                ...
                                <tr role="row">
                                    ...
                                    <td>
                                        <a href="{{ route('accounts.group', ['service' => $service, 'group_id' => $group->id]) }}" class="btn btn-primary">View</a>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModal" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <form class="forms-sample" id="redeem-form" method="POST" action="{{ route('groups.update', ['service' => $service]) }}">
            <div class="modal-body">
                @csrf
                <div class="form-group">
                    <label for="name">Group Name</label>
