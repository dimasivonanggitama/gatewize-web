...
<head>
	...
	<!-- plugin css for this page -->
		<link rel="stylesheet" href="{{ asset('css/additional_footer.css') }}">
    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <ul class="nav">
          <li class="nav-item nav-profile">
            <div class="nav-link">
              ...
              <a class="btn btn-success btn-block" href="{{ route('deposit-add') }}">Deposit
                <i class="mdi mdi-plus"></i>
              </a>
            </div>
          </li>
			<li class="nav-item">
				<a class="nav-link" href="#collapseFoto" data-toggle="collapse" data-parent="#profileParent" aria-expanded="false" aria-controls="collapseFoto">
					<i class="menu-icon mdi mdi-account-circle"></i>
					<span class="menu-title">Foto</span>
				</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="#collapseBiodata" data-toggle="collapse" data-parent="#profileParent" aria-expanded="false" aria-controls="collapseBiodata">
					<i class="menu-icon mdi mdi-information-outline"></i>
					<span class="menu-title">Biodata</span>
				</a>
            </li>
			<li class="nav-item">
				<a class="nav-link" href="#collapseAkun"data-toggle="collapse" data-parent="#profileParent" aria-expanded="false" aria-controls="collapseAkun">
      ...
      <div class="main-panel">
		<div class="row purchace-popup">
			<div class="col-12">
				<span class="bg-success d-block d-md-flex align-items-center">
					<i class="mdi mdi-check-circle text-light"></i>
					<p class="text-light">Berhasil melakukan update!</p>
			...
			<footer class="footer fixed_footer">
				<div class="container-fluid clearfix">
					<span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © 2019
					    <a href="http://www.google.com/" target="_blank">Gatewize</a>. All rights reserved.
					</span>
